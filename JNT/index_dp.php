...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <hr>
      <div>
      <h3 class="profile-username text-center"><?php echo $data['nama'];?> <i class=""></i></h3>

                <p class="text-muted text-center"><b><?php echo $data['nrp'];?></b></p>
                <p class="text-muted text-center"><b><?php echo $data['id_dp'];?></b></p>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">
            <a href="index_dp.php" class="nav-link active" style="background-color:red; color:white;">
          ...
          <li class="nav-item has-treeview ">
            <a href="?page2=aset" class="nav-link " >
          ...
          <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview ">
                    <a href="?page2=pengajuan_aset" class="nav-link ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview ">
                    <a href="?page2=data_pengajuan_aset" class="nav-link ">
                  <i class="nav-icon fas fa-circle"></i>
                  <p>
                    Data Pengajuan 
          ...
          <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview ">
                    <a href="?page2=pengajuan_service" class="nav-link ">
                  <i class="nav-icon fas fa-circle"></i>
                  <p>
                    pengajuan Service
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview ">
                    <a href="?page2=data_service" class="nav-link ">
                  <i class="nav-icon fas fa-circle"></i>
                  <p>
                    Data Service 
  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      if($page == "pengajuan_aset") {
        if ($aksi == "") {
          include "page2/pengajuan_aset/pengajuan_aset.php";
        } elseif ($aksi == "tambah"){
          include "page2/pengajuan_aset/tambah.php";
        } elseif ($aksi == "ubah"){
          include "page2/pengajuan_aset/ubah.php";
        } elseif ($aksi == "hapus"){
          include "page2/pengajuan_aset/hapus.php";
        } 
      } elseif ($page == "pengajuan_service"){
        if($aksi == "") {
            include "page2/pengajuan_service/pengajuan_service.php";
          } elseif ($aksi == "pengajuan"){ 
            include "page2/pengajuan_service/pengajuan.php";
          } elseif ($aksi == "pengajuan1"){ 
            include "page2/pengajuan_service/pengajuan1.php";
          } elseif ($aksi == "pengajuan2"){ 
            include "page2/pengajuan_service/pengajuan2.php";
          } 
      }  elseif ($page == "data_pengajuan_aset"){
        if($aksi == "") {
            include "page2/data_pengajuan_aset/data_pengajuan_aset.php";
          } elseif ($aksi == "buka"){ 
            include "page2/data_pengajuan_aset/data_pengajuan.php";
          }
      }  elseif ($page == "aset"){
        if($aksi == "") {
            include "page2/aset/data_aset.php";
          } elseif ($aksi == "buka"){ 
            include "page2/aset/data_aset.php";
          }
      }  elseif ($page == "data_service"){
        if($aksi == "") {
            include "page2/data_service/data_service.php";
          } elseif ($aksi == "buka"){ 
            include "page2/data_service/data_pengajuan.php";
          }
      } elseif ($page == ""){
        include "dp.php";
      }
