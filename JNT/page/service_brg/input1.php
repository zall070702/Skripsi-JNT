...
$sql=mysqli_query($koneksi,"SELECT * FROM brg_masuk_radio
INNER JOIN perawatan_brg Using (kd_asset_radio) 
      ...
      <div class="card-body"> 
        ...
        <div class="form-group">
          <label for="exampleInputEmail1">Kode Asset</label>
            <input type="text" class="form-control" id="exampleInputEmail1" value="<?php  echo $data1['kd_asset_radio'] ?>" placeholder="Masukkan Nama Kategori"name="kd_asset"readonly>
        </div>   
...
<div class="card card-primary card-tabs">
  <div class="card-header p-0 pt-1">
    <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link active" id="custom-tabs-two-home-tab" data-toggle="pill" href="#custom-tabs-two-home" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true">Office 101 HRGS</a>
      </li>
      <li class="nav-item">
        ...
        <div class="card mt-1 card-gray">
          ...
          <form role="form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                   ...
                   <input type="text" name="id_jasa"class="form-control" value="Karywan IT HRGS HRS-AGM" placeholder="Karywan IT HRGS HRS-AGM"> 
                ...
                <div class="form-group">
                   ...
                   <select name="id_jasa"class="form-control" >
                      ...
                      <?php
                       ...
                       $sql= mysqli_query($koneksi,"SELECT * FROM jasa_service where NOT id_jasa='JS001' ");
...
<?php
            ...
            if(isset($_POST['simpan_1'])){
              $kd_asset_radio = $data1['kd_asset_radio'];
              ...
              if($upload){
                ...
                $query4 = "UPDATE brg_masuk_radio SET kondisi_asset='$kondisi', kondisi_brg='$status_brg' WHERE kd_asset_radio='$kd_asset_radio'";
