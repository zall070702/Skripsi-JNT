...
$sql=mysqli_query($koneksi,"SELECT * FROM brg_masuk_komputer
INNER JOIN perawatan_brg Using (kd_asset_pc) 
      ...
      <div class="card-body"> 
        ...
        <div class="form-group">
          <label for="exampleInputEmail1">Kode Asset</label>
            <input type="text" class="form-control" id="exampleInputEmail1" value="<?php  echo $data1['kd_asset_pc'] ?>" placeholder="Masukkan Nama Kategori"name="kd_asset"readonly>
        </div>   
...
<?php
            ...
            if(isset($_POST['simpan_1'])){
              ...
              if($upload){
                ...
                $query4 = "UPDATE brg_masuk_komputer SET kondisi_asset='$kondisi', kondisi_brg='$status_brg' WHERE kd_asset_pc='$kd_asset_pc'";
