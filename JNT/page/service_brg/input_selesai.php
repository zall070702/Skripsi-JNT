        ...
        <div class="card-footer">
          <button type="submit" class="btn btn-success" name="simpan">Submit</button>
                ...
                if(isset($_POST['simpan'])){
                  ...
                  $sql = mysqli_query($koneksi,"UPDATE service SET foto_nota='$foto_nota', catatan_perbaikan='$catatan_perbaikan', harga_service='$harga_service', tgl_selesai=CURDATE() WHERE id_service='$id'"); 
