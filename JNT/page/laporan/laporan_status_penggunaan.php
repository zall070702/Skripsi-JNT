...
<hr>
   <h3><center><b>LAPORAN STATUS PENGGUNAAN ASET PADA <?php
      if($bulan1 != ''){
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">Lokasi Aset</th>
   <th width="25px" height="50px">Kondisi</th>
    ...
    <tbody>
        ...
        WHERE $where and brg_masuk_peralatan.status='Terpakai'
        order by kondisi_brg ") or die($koneksi->error);
        ...
        ?>
          <tr>
              ...
              <td width="100px" height="50px"><center><?php echo $data['id_dp'].' '.$data['lokasi'];?></center></td>
