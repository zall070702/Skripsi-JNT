              ...
              <form role="form" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <table class="table table-borderless" style="width: 100%"> 
                    ...
                    <th><h3><center><b> DATA BARANG ASSET </b></center></h3></th>
                    </tr>
                  </table><?php
...
?>
    ...
    <table class="table table-borderless" style="width: 90%">
          <br>
          <tr>
                <td style="text-align: left; width: 30%;"><strong><h5><b>Nomor Pengajuan Asset </h5></b></strong></td>
              ...
              <tr>
                ...
                <td style="text-align: left; width: 60%;"><strong><h5>:&nbsp<b> <?php echo $data['kd_asset'] ?>/<?php echo $data['kd_asset_pc'] ?></h5></b></strong></td>
              </tr>
...
<div class="card card-gray card-tabs">
  <div class="card-header p-0 pt-1">
    <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link active" id="custom-tabs-two-home-tab" data-toggle="pill" href="#custom-tabs-two-home" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true">Pemakaian</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="custom-tabs-two-profile-tab" data-toggle="pill" href="#custom-tabs-two-profile" role="tab" aria-controls="custom-tabs-two-profile" aria-selected="false">Maintenance</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="custom-tabs-two-messages-tab" data-toggle="pill" href="#custom-tabs-two-messages" role="tab" aria-controls="custom-tabs-two-messages" aria-selected="false">Service</a>
      </li>
    </ul>
</div>
  <div class="card-body">
    <div class="tab-content" id="custom-tabs-two-tabContent">
      ...
      <div class = "card mt-1 card-success">
        ...
        <table id="example1" class="table table table-striped table-hover">
            ...
            Where status_brg='Service' and kd_asset='$id'
            ");
