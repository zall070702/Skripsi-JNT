...
<hr>
   <h3><center><b>LAPORAN DATA KERUSAKAN BARANG ASSET PADA BULAN <?php echo  bulan_indo((int)$bulan1); ?>  </b></center></h3>
<table class="table table-borderless" style="width: 100%"> 
  <tr>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">Kondisi</th>
   <th width="25px" height="50px">Status Barang</th>
   <th width="25px" height="50px">Tanggal Kerusakan</th>
   <th width="25px" height="50px">Catatan Kerusakan</th>
    ...
    <tbody>
        ...
        AND kondisi_brg='Rusak'
        AND id_perawatan IN (Select Max(id_perawatan) From perawatan_brg GROUP BY kd_asset_radio)
        ...
        ?>
          <tr>
              ...
              <td width="100px" height="50px"><center><?php echo $data['kondisi_asset'];?></center></td>
        ...
        AND YEAR(tgl_perawatan)='$tahun'
        AND kondisi_brg='Rusak'
        AND id_perawatan IN (Select Max(id_perawatan) From perawatan_brg GROUP BY kd_asset_pc)
        order by id_kategori desc
        ");
        while ($data=$sql->fetch_assoc()) {
