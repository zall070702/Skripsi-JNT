...
<hr>
   <h3><center><b>LAPORAN DATA ASSET PC/LAPTOP KELUAR PADA BULAN <?php echo  bulan_indo((int)$bulan1); ?>  </b></center></h3>
<table class="table table-borderless" style="width: 100%"> 
  <tr>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">Nama Karyawan</th>
   ...
   <th width="25px" height="50px">Serial Number</th>
   <th width="25px" height="50px">Tanggal Keluar</th>
    ...
    <?php
        ...
        ?>
          <tr>
              ...
              <td width="100px" height="50px"><center><?php echo format_indo(date($data['tgl_keluar']));?></center></td>
              <td width="100px" height="50px"><center><?php echo $data['keterangan'];?> </center></td> 
         </tr>  
        
        <?php
        }
        $sql = $koneksi ->query("SELECT * from  brg_keluar_komputer
        inner join karyawan using(id_karyawan)
        ...
        $sql = $koneksi ->query("SELECT * from  brg_keluar_peralatan
        inner join karyawan using(id_karyawan)
        ...
        <?php }  ?>
            ...
            <!-- <?php $bua = mysqli_query($koneksi,"SELECT *, count(id_pengajuan) as total
              ...
              WHERE YEAR(tgl_pengajuan_diterima)='$tahun' AND MONTH(tgl_pengajuan_diterima)='$bulan1' AND status_brg='DISIMPAN'
              ");
               ...
               WHERE
              YEAR(pengajuan_msk.tgl_masuk)='$tahun' AND MONTH(pengajuan_msk.tgl_masuk)='$bulan1' AND status_brg='DISIMPAN' ORDER BY pengajuan_msk.tgl_masuk Asc ");?>
