...
<hr>
   <h3><center><b>LAPORAN DATA MAINTENANCE BARANG ASSET PADA BULAN <?php echo  bulan_indo((int)$bulan1); ?>  </b></center></h3>
<table class="table table-borderless" style="width: 100%"> 
  <tr>
    ...
    <tbody>
        ...
        ?>
          <tr>
              ...
              <td width="100px" height="50px"><center><?php echo $data['kondisi'];?></center></td>
