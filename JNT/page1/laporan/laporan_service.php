...
<hr>
   <h3><center><b>LAPORAN DATA SERVICE BARANG ASSET PADA BULAN <?php echo  bulan_indo((int)$bulan1); ?>  </b></center></h3>
<table class="table table-borderless" style="width: 100%"> 
  <tr>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">Nomor Service</th>
   ...
   <th width="25px" height="50px">Jenis Service</th>
   <th width="25px" height="50px">Tempat Service</th>
   <th width="25px" height="50px">Tanggal Service Selesai </th>
   ...
   <th width="25px" height="50px">Catatan</th>
    ...
    <tbody>
        ...
        WHERE MONTH(tgl_selesai)='$bulan1'
        AND YEAR(tgl_selesai)='$tahun'
        ...
        ?>
          <tr>
              ...
              <td width="100px" height="50px"><center><?php echo $data['id_service'];?></center></td>
              ...
              <td width="100px" height="50px"><center><?php echo $data['nama_service'];?></center></td>
              <td width="100px" height="50px"><center><?php echo format_indo(date($data['tgl_selesai']));?></center></td>
              <td width="100px" height="50px"><center>Rp.<?php echo number_format($data['harga_service'],0,',','.');?></center></td>
              <td width="100px" height="50px"><center><?php echo $data['catatan_perbaikan'];?></center></td>
         </tr>  
        <?php   } ?>
        <?php
