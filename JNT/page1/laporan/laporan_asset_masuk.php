...
<hr>
   <h3><center><b>LAPORAN DATA ASSET MASUK PADA BULAN <?php echo  bulan_indo((int)$bulan1); ?>  </b></center></h3>
<table class="table table-borderless" style="width: 100%"> 
  <tr>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">MDA</th>
   <th width="25px" height="50px">Kategori</th>
   <th width="25px" height="50px">Tanggal Diterima</th>
   <th width="25px" height="50px">Quantity</th>
    ...
    <tbody>
        ...
        ?>
          <tr>
              ...
              <td width="100px" height="50px"><center><?php echo $data['mda'];?></center></td>
              ...
              <td width="100px" height="50px"><center><?php echo $data['quantity'];?></center></td>
